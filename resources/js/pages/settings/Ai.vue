        ...
        <Form @submit.prevent="form.submit(aiRoutes.update())">
            <Card :class="['gap-0 overflow-hidden py-0', spotlightClass('ai')]">
                ...
                <CardHeader class="border-b py-4">
                    ...
                    <CardDescription>Use an LLM to generate concise, client-facing summaries for each activity line.</CardDescription>
                ...
                <CardFooter class="flex items-center justify-between gap-4 bg-muted/40 px-6 py-3">
                    <p class="text-xs text-muted-foreground">Summaries are generated once per report, in batch, using your configured provider.</p>
